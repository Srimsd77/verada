    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('waiver_type', models.CharField(blank=True, choices=[('minimus', 'Minimus'), ('space', 'Space')], max_length=20, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='AuditCommoditi',
            fields=[
                ...
                ('contamination_weight', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
