...
def save_mapped_data(request):
    ...
    try:
        ...
        for i in range(len(collectorname)):
            ...
            cursor.execute(f"SELECT address_line_1 FROM common_address where address_line_1 in ('{address_name}') ")
            ...
            collector_address, created = Address.objects.get_or_create(address_line_1=address_name)
